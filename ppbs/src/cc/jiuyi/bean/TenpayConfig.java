...
public class TenpayConfig {
	...
	public static final String RETURN_URL = "/platform/payment!tenpayReturn.action";// 处理返回结果的URL
	public static final String SHOW_URL = "/platform/payment!result.action";// 支付完成显示URL

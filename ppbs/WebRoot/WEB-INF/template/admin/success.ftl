						...
						<div class="row">
							<div class="col-xs-12" >
								<!-- ./ add by welson 0728 -->
									...
									<div class="error-container widget-box widget-color-green ui-sortable-handle" style="margin-left:30%;margin-right:30%;margin-top:15%;">
											<div class="widget-header">
												<h5 class="widget-title">提示信息</h5>
											...
											<button class="btn btn-lg btn-success" <#if redirectionUrl>onclick="window.location.href='${redirectionUrl}'"<#else>onclick="window.history.back(); return false;"</#if>>

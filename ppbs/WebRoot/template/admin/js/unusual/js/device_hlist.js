...
jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		url:"device!ajlist.action?abnorId="+$id,
		datatype: "json",
		...
		colModel:[
		    {name:'deviceName',index:'equipments.equipmentName',width:100, editable:true},	
			{name:'workPlatformName',index:'workPlatform.workPlatformName',width:60, editable:true, sorttype:"date",unformat: pickDate},
			{name:'contactName',index:'workplatformLinkman.name', width:60,editable: true,search:false,editoptions:{size:"20",maxlength:"30"}},

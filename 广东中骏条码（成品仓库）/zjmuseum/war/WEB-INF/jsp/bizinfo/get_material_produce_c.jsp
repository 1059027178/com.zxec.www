...
<BODY>
	<div class="div">
		<form id="form" name="form" action="/getMaterialD.do" method="post" onsubmit="return false;">
			<table class="table_list" style="width:100%;margin-top:40px;margin-left:20px">
				...
				<table class="table_list" style="width:100%;margin-left:20px">
					...
					<table style="width:80%;margin-left:20px;margin-right:20px">
						<tr>
							...
							<td align="center">
								<input type="button" class="button" style="width:40px;" value="<<" onclick="previousPage();" />
							</td>
							<td align="center">

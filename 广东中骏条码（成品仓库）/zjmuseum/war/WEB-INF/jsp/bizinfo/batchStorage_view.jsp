...
<style type="text/css">
  ...
  <div>
     <ul>
     <li class="li"></li>
		<li class="li">工  &nbsp;&nbsp; 厂：<input name="werks" class="text" style="width:90px;background-color:white;" type="text" id="werks" value="3200">	
 		</li>
		<li class="li">移动类型：<input name="bwlvs" class="text" style="width:90px;background-color:white;" type="text" id="bwlvs" value="311">	
 		</li>
 		<li class="li"></li>
		<li class="li">

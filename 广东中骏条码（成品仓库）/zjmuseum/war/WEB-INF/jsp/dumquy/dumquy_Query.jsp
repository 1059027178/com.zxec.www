...
function dumQuy(){
  ...
  <body>
    <form name="jiuhui"  id="jiuhui" action="/dumquyView.do">
    	...
    	<li class="li"></li>
    		<li class="li">
    			仓 库 号：<input type="text" id="lgnum"  style="width:50%;heigth=70%" name="lgnum"  value="320"/>
    		</li>
    		<li class="li">
    		...
    		<li class="li">
    			<td align="center">
    				<input type="button" class=button onclick="dumQuy()" style="margin-left: -30px;" value="查询">
    				<input type="button" class=button onclick="window.location.href='/main.do?two=5';" value="返回">

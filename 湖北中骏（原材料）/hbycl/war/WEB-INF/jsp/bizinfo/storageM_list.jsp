...
<div class="div">
	...
	<input type="hidden" name="lgnum" id="lgnum" value="<%=lgnum %>"/>
		...
		<tr>
			...
			<input value="确定" class="button" style="width:40px;" type="submit"/>
			<input   type="button" class="button" style="width:40px;" value="返回" onclick="window.location.href='/main.do?two=4';"/>

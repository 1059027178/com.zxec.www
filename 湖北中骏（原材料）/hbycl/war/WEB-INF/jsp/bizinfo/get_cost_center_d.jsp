...
<BODY>
	<div class="div">
		<form id="form" name="form" action="/getCostB.do"
			...
			<table class="table_list"
				...
				<input type="hidden" name="werks" value="<%=werks%>"> <input
			...
			<table style="width:80%;margin-top:40px;margin-left:20px">
				<tr>
					<td align="center"><input type="button" class="button"
						style="width:40px;" value="继续" onclick="continues()" /></td>
					<td align="center"><input type="button" class="button"
						style="width:40px;" value="返回" onclick="fanhui();"/>
						<!-- onclick="window.location.href='/delivery.do?functionType=4';" /> -->
					</td>
					<td align="center"><input type="button" class="button"
						style="width:80px;" value="记账变更" onclick="lubuView()" /></td>
				</tr>
			</table>
		</form>
	</div>

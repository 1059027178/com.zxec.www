...
<body>
	...
	<div id="page1">
		<div style="padding-top:50px;">
			...
			<ul>
				<li style="height:15px;list-style-type:none;">研发领料单</li>
			...
			<table class="table_page">
				...
				<tr>
					...
					<td><input class="button" type="button" valign="center"
						style="width:40px;height:25px;" id="back1" value="返回" />
					</td>
					<td><input type="text" valign="center"
						style="width:40px;height:20px;" id="jumpTable" />
					</td>
				</tr>
			</table>
		</div>
		...
		<div style="padding-top:50px;">
			...
			<table class="table_page">
				...
				<tr>
					...
					<td><input class="button" type="button" valign="center"
						style="width:40px;height:25px;" id="back2" value="返回" />
					</td>
				</tr>
			</table>
		</div>
	...
	<div id="pageC" style="display:none">
		<div style="padding-top:50px;">
			<ul>
				<li class="li">物料编码：<label id="materiIdShow"></label></li>
				<li class="li">物料描述：<label id="descriptionShow"></label></li>
				<li class="li">需求数量：<label id="requireAmount"></label></li>
			</ul>
			<table class="table_page">
				<tr>
					<td>序号</td>
				...
				<tr>
					...
					<td><input class="button" type="button" valign="center"
						style="width:60px;height:25px;" id="nextItem" value="下一项" />
					</td>
				</tr>
			</table>
		</div>
			...
			<table class="table_page">
				...
				<tr>
					...
					<td><input class="button" type="button" valign="center"
						...
						onclick="window.location.href='/lubuView.do';" value="记账变更" />
					</td>
				</tr>
			</table>
		</div>
...
<script type="text/javascript">
	...
	pager3.paraArr = new Array("num", "wareHouse", "batch", "_turn", "_hidden[class=checkWarehouse]", "enabledAmount",
			"_text[class=selectAmount]");

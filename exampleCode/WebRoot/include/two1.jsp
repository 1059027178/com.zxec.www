...
<table   class="table_border">
  	<tr>
  	<td>
    	<input  class="button" type="button" style="width:200px" onclick="window.location.href='MainServlet?flag=1.1';" value="1.1 PO收货"/>
    </td>
    </tr>
    <tr>
    <td>
    	<input  class="button" type="button" style="width:200px" onclick="window.location.href='MainServlet?flag=1.2';" value="1.2 上架" />
    </td>
    </tr>
    <tr>
  	<td>
    	<input  class="button" type="button" style="width:200px" onclick="window.location.href='MainServlet?flag=1.3';" value="1.3 PO收货冲销"/>
    </td>
    </tr>
    <tr>
    <td>

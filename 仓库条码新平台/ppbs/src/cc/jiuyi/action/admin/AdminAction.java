...
public class AdminAction extends BaseAdminAction {
	...
	// 保存
	@Validations(requiredStrings = { @RequiredStringValidator(fieldName = "admin.username", message = "登录名不允许为空!"),

...
public class SystemConfigUtil {
	...
	public static final String CONFIG_FILE_NAME = "tkwrdp.xml";// 系统配置文件名称
	...
	public static SystemConfig getSystemConfig() {
		...
		Node systemNameNode = document.selectSingleNode("/tkwrdp/systemConfig/systemName");
		Node systemVersionNode = document.selectSingleNode("/tkwrdp/systemConfig/systemVersion");
		Node systemDescriptionNode = document.selectSingleNode("/tkwrdp/systemConfig/systemDescription");
		Node isInstalledNode = document.selectSingleNode("/tkwrdp/systemConfig/isInstalled");
		Node platformNameNode = document.selectSingleNode("/tkwrdp/systemConfig/platformName");
		Node platformUrlNode = document.selectSingleNode("/tkwrdp/systemConfig/platformUrl");
		Node platformLogoNode = document.selectSingleNode("/tkwrdp/systemConfig/platformLogo");
		Node hotSearchNode = document.selectSingleNode("/tkwrdp/systemConfig/hotSearch");
		Node metaKeywordsNode = document.selectSingleNode("/tkwrdp/systemConfig/metaKeywords");
		Node metaDescriptionNode = document.selectSingleNode("/tkwrdp/systemConfig/metaDescription");
		Node addressNode = document.selectSingleNode("/tkwrdp/systemConfig/address");
		Node phoneNode = document.selectSingleNode("/tkwrdp/systemConfig/phone");
		Node zipCodeNode = document.selectSingleNode("/tkwrdp/systemConfig/zipCode");
		Node emailNode = document.selectSingleNode("/tkwrdp/systemConfig/email");
		Node currencyTypeNode = document.selectSingleNode("/tkwrdp/systemConfig/currencyType");
		Node currencySignNode = document.selectSingleNode("/tkwrdp/systemConfig/currencySign");
		Node currencyUnitNode = document.selectSingleNode("/tkwrdp/systemConfig/currencyUnit");
		Node priceScaleNode = document.selectSingleNode("/tkwrdp/systemConfig/priceScale");
		Node priceRoundTypeNode = document.selectSingleNode("/tkwrdp/systemConfig/priceRoundType");
		Node orderScaleNode = document.selectSingleNode("/tkwrdp/systemConfig/orderScale");
		Node orderRoundTypeNode = document.selectSingleNode("/tkwrdp/systemConfig/orderRoundType");
		Node certtextNode = document.selectSingleNode("/tkwrdp/systemConfig/certtext");
		Node storeAlertCountNode = document.selectSingleNode("/tkwrdp/systemConfig/storeAlertCount");
		Node storeFreezeTimeNode = document.selectSingleNode("/tkwrdp/systemConfig/storeFreezeTime");
		Node uploadLimitNode = document.selectSingleNode("/tkwrdp/systemConfig/uploadLimit");
		Node isLoginFailureLockNode = document.selectSingleNode("/tkwrdp/systemConfig/isLoginFailureLock");
		Node loginFailureLockCountNode = document.selectSingleNode("/tkwrdp/systemConfig/loginFailureLockCount");
		Node loginFailureLockTimeNode = document.selectSingleNode("/tkwrdp/systemConfig/loginFailureLockTime");
		Node isRegisterNode = document.selectSingleNode("/tkwrdp/systemConfig/isRegister");
		Node watermarkImagePathNode = document.selectSingleNode("/tkwrdp/systemConfig/watermarkImagePath");
		Node watermarkPositionNode = document.selectSingleNode("/tkwrdp/systemConfig/watermarkPosition");
		Node watermarkAlphaNode = document.selectSingleNode("/tkwrdp/systemConfig/watermarkAlpha");
		Node bigProductImageWidthNode = document.selectSingleNode("/tkwrdp/systemConfig/bigProductImageWidth");
		Node bigProductImageHeightNode = document.selectSingleNode("/tkwrdp/systemConfig/bigProductImageHeight");
		Node smallProductImageWidthNode = document.selectSingleNode("/tkwrdp/systemConfig/smallProductImageWidth");
		Node smallProductImageHeightNode = document.selectSingleNode("/tkwrdp/systemConfig/smallProductImageHeight");
		Node thumbnailProductImageWidthNode = document.selectSingleNode("/tkwrdp/systemConfig/thumbnailProductImageWidth");
		Node thumbnailProductImageHeightNode = document.selectSingleNode("/tkwrdp/systemConfig/thumbnailProductImageHeight");
		Node defaultBigProductImagePathNode = document.selectSingleNode("/tkwrdp/systemConfig/defaultBigProductImagePath");
		Node defaultSmallProductImagePathNode = document.selectSingleNode("/tkwrdp/systemConfig/defaultSmallProductImagePath");
		Node defaultThumbnailProductImagePathNode = document.selectSingleNode("/tkwrdp/systemConfig/defaultThumbnailProductImagePath");
		Node allowedUploadImageExtensionNode = document.selectSingleNode("/tkwrdp/systemConfig/allowedUploadImageExtension");
		Node allowedUploadMediaExtensionNode = document.selectSingleNode("/tkwrdp/systemConfig/allowedUploadMediaExtension");
		Node allowedUploadFileExtensionNode = document.selectSingleNode("/tkwrdp/systemConfig/allowedUploadFileExtension");
		Node smtpFromMailNode = document.selectSingleNode("/tkwrdp/systemConfig/smtpFromMail");
		Node smtpHostNode = document.selectSingleNode("/tkwrdp/systemConfig/smtpHost");
		Node smtpPortNode = document.selectSingleNode("/tkwrdp/systemConfig/smtpPort");
		Node smtpUsernameNode = document.selectSingleNode("/tkwrdp/systemConfig/smtpUsername");
		Node smtpPasswordNode = document.selectSingleNode("/tkwrdp/systemConfig/smtpPassword");
		
		Node sapHostNode = document.selectSingleNode("/tkwrdp/systemConfig/sapHost");
		Node sapClientNode = document.selectSingleNode("/tkwrdp/systemConfig/sapClient");
		Node sapSysnrNode = document.selectSingleNode("/tkwrdp/systemConfig/sapSysnr");
		Node sapUserNode = document.selectSingleNode("/tkwrdp/systemConfig/sapUser");
		Node sapPasswdNode = document.selectSingleNode("/tkwrdp/systemConfig/sapPasswd");
		Node sapLangNode = document.selectSingleNode("/tkwrdp/systemConfig/sapLang");
		Node sapCodePageNode = document.selectSingleNode("/tkwrdp/systemConfig/sapCodePage");
		
		Node pointTypeNode = document.selectSingleNode("/tkwrdp/systemConfig/pointType");
		Node pointScaleNode = document.selectSingleNode("/tkwrdp/systemConfig/pointScale");
		...
		systemConfig.setPlatformName(platformNameNode.getText());
		systemConfig.setPlatformUrl(platformUrlNode.getText());
		systemConfig.setPlatformLogo(platformLogoNode.getText());
		...
		systemConfig.setSapHost(sapHostNode.getText());
		systemConfig.setSapClient(sapClientNode.getText());
		systemConfig.setSapSysnr(sapSysnrNode.getText());
		systemConfig.setSapUser(sapUserNode.getText());
		systemConfig.setSapPasswd(sapPasswdNode.getText());
		systemConfig.setSapLang(sapLangNode.getText());
		systemConfig.setSapCodePage(sapCodePageNode.getText());
	...
	public static void update(SystemConfig systemConfig) {
		...
		if(platformNameNode == null){
			platformNameNode = systemConfigElement.addElement("platformName");
		}
		if(platformUrlNode == null){
			platformUrlNode = systemConfigElement.addElement("platformUrl");
		}
		if(platformLogoNode == null){
			platformLogoNode = systemConfigElement.addElement("platformLogo");
		}
		...
		if(sapHostNode == null){
			sapHostNode = systemConfigElement.addElement("sapHost");
		}
		if(sapClientNode == null){
			sapClientNode = systemConfigElement.addElement("sapClient");
		}
		if(sapSysnrNode == null){
			sapSysnrNode = systemConfigElement.addElement("sapSysnr");
		}
		if(sapUserNode == null){
			sapUserNode = systemConfigElement.addElement("sapUser");
		}
		if(sapPasswdNode == null){
			sapPasswdNode = systemConfigElement.addElement("sapPasswd");
		}
		if(sapLangNode == null){
			sapLangNode = systemConfigElement.addElement("sapLang");
		}
		if(sapCodePageNode == null){
			sapCodePageNode = systemConfigElement.addElement("sapCodePage");
		}
...
//		platformNameNode.setText(systemConfig.getPlatformName());
//		platformUrlNode.setText(StringUtils.removeEnd(systemConfig.getPlatformUrl(), "/"));
//		platformLogoNode.setText(systemConfig.getPlatformLogo());
...
//		smtpPasswordNode.setText(systemConfig.getSmtpPassword());
		...
		sapHostNode.setText(systemConfig.getSapHost());
		sapClientNode.setText(systemConfig.getSapClient());
		sapSysnrNode.setText(systemConfig.getSapSysnr());
		sapUserNode.setText(systemConfig.getSapUser());
		sapPasswdNode.setText(systemConfig.getSapPasswd());
		sapLangNode.setText(systemConfig.getSapLang());
		sapCodePageNode.setText(systemConfig.getSapCodePage());

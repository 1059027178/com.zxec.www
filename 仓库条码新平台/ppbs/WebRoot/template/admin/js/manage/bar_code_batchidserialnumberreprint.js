function print_event(id)
{
	...
	if(rowData.lifnr!=null&&rowData.lifnr!='')//批次号不为空，同时要显示
	{
		var sernr=rowData.sernr;
		sernr=sernr.split("/")[1];
		rowData.sernr=rowData.lifnr+'/'+sernr;
	}
...
jQuery(function($) {	
	...
	$("#grid-table").jqGrid({
		url : "bar_code!getBatchIdSerialNumberList.action?factory="+$("#factory").val()+"&matnr="+$("#matnr").val(),
		datatype : "json",

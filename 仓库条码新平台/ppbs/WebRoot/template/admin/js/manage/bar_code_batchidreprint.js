	...
	var index = layer.open(
			{
				...
				yes : function() 
				{
					...
					{	
						...
						print(rowData.descrip,rowData.lifnr,$("#amount").val());
					}											
					layer.close(index);
				}
			});			
	...
	var index = layer.open(
			{
				...
				yes : function() 
				{
					...
					{	
						var rowData = $("#grid-table").jqGrid('getRowData',id);
						printLittle(rowData.descrip,rowData.lifnr,$("#amount").val());
					}											
					layer.close(index);
				}
			});			
...
function print(maktx,batchId,num)
{
	while(num--)
	{
		printBigLable(batchId,maktx);
	}
}

function printLittle(maktx,batchId,num)
{
	while(num--)
	{
		printLittleLable(batchId,maktx);
	}
}
...
jQuery(function($) {	
	...
	$("#grid-table").jqGrid({
		url : "bar_code!getBatchIdLabelList.action?factory="+$("#factory").val()+"&matnr="+$("#matnr").val(),		
		datatype : "json",

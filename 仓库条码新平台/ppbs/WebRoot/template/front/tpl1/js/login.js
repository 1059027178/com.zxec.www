...
$().ready( function() {
	...
	function loginWindowCaptchaImageRefresh() {
		$("#loginWindowCaptchaImage").attr("src", tcrm.base + "/captcha.jpg?timestamp" + (new Date()).valueOf());
	}
	...
	function loginCaptchaImageRefresh() {
		$("#loginCaptchaImage").attr("src", tcrm.base + "/captcha.jpg?timestamp" + (new Date()).valueOf());
	}

...
$(function() {
	...
	function generation(currentPageNum) {
		...
		$("#factory").html(queryLineItems[index].WERKS);
		$("#special_storage").html(queryLineItems[index].SOBKZ);
		$("#special_storage_id").html(queryLineItems[index].SONUM);
		$("#batch").html(queryLineItems[index].CHARG);
		$("#picking_area").html(queryLineItems[index].KBERT)
		$("#material_description").html(queryLineItems[index].MAKTX);
		$("#storage_type").html(queryLineItems[index].LTYPT);
		$("#storage_location").html(queryLineItems[index].LGOBE);

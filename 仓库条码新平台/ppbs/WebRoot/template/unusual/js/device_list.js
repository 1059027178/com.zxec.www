jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		colModel:[
			...
			{name:'workPlatform',index:'workPlatform',width:60, editable:true, sorttype:"date",unformat: pickDate},
			{name:'workplatformLinkman',index:'workplatformLinkman', width:60,editable: true,editoptions:{size:"20",maxlength:"30"}},

										...
										<div class="profile-info-value">
											<div class="example">
												<fieldset id="self-data">
													<div class="form">
														<select name="factoryid" class="factory select"  data-first-title="请选择..." data-value="${(department.team.factoryUnit.workPlatform.factory.id)! }" data-url="department!getFactory.action" data-json-space="factory"></select>
														<select name="workplatformid"	class="workplatform select"  data-first-title="请选择..." data-value="${(department.team.factoryUnit.workPlatform.id)! }" data-url="department!getWorkplatform.action" data-json-space="workplatform"></select>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#self-data").cxSelect({
			selects: ['factory', 'workplatform', 'factoryunit','team'],
			jsonName: 'name',
			jsonValue: 'value'
		},function(select){//回调

...
<LINK href="/css/jiuhui_list.css" type=text/css rel=STYLESHEET>
  <script  type="text/javascript">
  	...
  	function xiangtong(){
  		document.getElementById("lgort_to").value=document.getElementById("lgort_from").value;
  	}
  </script>
</HEAD>
<BODY>
	...
	<form  id="thinkway" name="thinkway" method="post" action="/dumpAdd.do">
		...
		<input type="hidden" name="radio" id="radio" value="2">
			...
			<table  class="table_list">
				...
				<tr>
					<td  >数量:</td>
					<td  ><input style="width:50%" name="menge" type="text"  id="menge"></td>
				</tr>
				<tr>
					<td >库存地点:</td>
					<td  ><input name="lgort_from" type="text" style="width:25%"  id="lgort_from" onchange="xiangtong()">到<input readonly="readonly" name="lgort_to" type="text" style="width:25%"  id="lgort_to"></td>	</tr>
				<tr>
					<td >特殊库存:</td>
					<td  >${sobkz}${sonum}</td>
				</tr>
				<tr>
					<td >移动类型:</td>
					<td  ><input readonly=readonly name="bwart" size="3" style="width:35%" type="text"  id="bwart" value="321"></td>
				</tr>
					<tr>
					<td align="center" colspan="2">
							<input type="submit" style="width:40px;heigth=20%" onclick="return validateForm()" value="过账"></input>
							<input type="button" style="width:40px;heigth=20%" value="返回" onclick="window.location.href='/dumpView.do';"></input>
							<input type="button" style="width:40px;height:20%;" onclick="window.location.href='/main.do';" value="首页">
					</td>
				</tr>
			</table>

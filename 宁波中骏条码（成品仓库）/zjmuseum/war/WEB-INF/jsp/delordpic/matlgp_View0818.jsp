...
<link href="/css/jiuhui_list.css" rel="stylesheet">
  ...
  <script  type="text/javascript">
  	...
  	function lastPage(){
  		...
  		document.thinkway.action="/matlgpView.do";
  		document.thinkway.submit();
  	}
  	function nextPage(){
  		var pageNo=<%=pageNo%>;
	...
	<input type="hidden" name="wadat" id="wadat" value="<%=wadat %>"/>
			...
			<table class="table_list" style="width:100%">
				...
				<tr class="tr_list_1" bordercolor="#000000" >
					<td class="td_list" style="width:30%;">序号</td>
			...
			<tr>
				<td><input type="button" style="width:40px;" onclick="lastPage()" value="上一页"></td>
				<td>
				<input type="hidden" name="maxxuhao" id="maxxuhao" value="<%=i %>"/>
				...
				<td><input type="button" style="width:40px;" onclick="nextPage()" value="下一页"></td>
			</tr>

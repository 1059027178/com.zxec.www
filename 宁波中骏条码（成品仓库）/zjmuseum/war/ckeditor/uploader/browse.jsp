...
if(userId==null||userId.equals("")){
	...
	String clientPath = "ckeditor/uploader/upload/" + userId + "/"  + type;
	...
	if(files.length > 0){
		for(File file:files ) {
			...
			out.println("<img width='120px' height='120px' src='" + src + "' alt='" + file.getName() + "' onclick=\"funCallback("+callback+",'"+ src +"')\">");
		}
	}else{

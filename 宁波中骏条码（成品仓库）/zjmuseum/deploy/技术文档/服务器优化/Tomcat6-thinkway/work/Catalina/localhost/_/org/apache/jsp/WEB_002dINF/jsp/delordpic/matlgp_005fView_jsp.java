...
public final class matlgp_005fView_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String uploadDir = "/ckeditor/uploader/upload/";
	...
	String wadat=LiangxinUtil.null2String((String)request.getAttribute("wadat"));
      ...
      out.write("  \t\tdocument.thinkway.action=\"/matlgpView.do\";\r\n");
      out.write("  \t\tdocument.thinkway.submit();\r\n");
      out.write("  \t}\r\n");
	...
	return;} 
      ...
      out.write("\t\t\t\t\t<td class=\"td_list\" style=\"width:30%;\">序号</td>\r\n");

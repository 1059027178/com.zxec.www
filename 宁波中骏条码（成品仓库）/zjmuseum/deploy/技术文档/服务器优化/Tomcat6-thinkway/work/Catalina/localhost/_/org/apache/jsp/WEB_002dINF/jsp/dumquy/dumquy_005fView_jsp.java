...
public final class dumquy_005fView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/WEB-INF/jsp/dumquy/../include/const.jsp");
...
String uploadDir = "/ckeditor/uploader/upload/";
	...
	String lgnum=LiangxinUtil.null2String((String)request.getAttribute("lgnum"));
      ...
      out.write("  \t\tdocument.listForm.action=\"/dumquyView.do\";\r\n");
      ...
      out.write("\t<input type=\"hidden\" id=\"tanum\" name=\"tanum\" value=\"");
      out.print(tanum );
      out.write("\"/>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<input type=\"button\" style=\"width:50px;heigth=20%\" value=\"返回\" onclick=\"window.location.href='/dumquyQuery.do';\"></input>\r\n");
...
if(list.size()==0){
	...
	return;} 
      ...
      out.write("\t\t\t\t<tr bordercolor=\"#000000\" class=\"tr_list_2\">\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">转储单</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">");
      out.print(dum.getTanum() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr bordercolor=\"#000000\" class=\"tr_list_1\">\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">行项目</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">");
      out.print(dum.getPosnr() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr bordercolor=\"#000000\" class=\"tr_list_2\">\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">物料</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">");
      out.print(dum.getMatnr() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr bordercolor=\"#000000\" class=\"tr_list_1\">\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">批次</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">");
      out.print(dum.getCharg() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr bordercolor=\"#000000\" class=\"tr_list_2\">\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">数量</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">");
      out.print(dum.getVsolm() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr bordercolor=\"#000000\" class=\"tr_list_1\">\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">创建者</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\" >");
      out.print(dum.getBname() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr bordercolor=\"#000000\" class=\"tr_list_2\">\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">证书号</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">");
      out.print(dum.getZeugn() );
      out.write("</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr bordercolor=\"#000000\" class=\"tr_list_1\">\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">源仓位</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">");
      out.print(dum.getVdifm() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr bordercolor=\"#000000\" class=\"tr_list_2\">\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">目标仓位</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">");
      out.print(dum.getNplei() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td align=\"center\" colspan=\"4\">\r\n");
      out.write("\t\t\t\t\t\t\t<input  type=\"button\"class=button value=\"上一页\" onclick=\"lastPage();\"/>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"button\"  class=button value=\"返回\" onclick=\"window.location.href='/dumquyQuery.do';\"/>\r\n");
      out.write("\t\t\t\t\t\t\t<input  class=button type=\"button\" onclick=\"window.location.href='/main.do';\" value=\"首页\">\r\n");
      out.write("\t\t\t\t\t\t\t<input  type=\"button\" class=button value=\"下一页\" onclick=\"nextPage();\"/>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t\t</div>\r\n");

...
public final class delord_005fList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String uploadDir = "/ckeditor/uploader/upload/";
	...
	String wadat=LiangxinUtil.null2String((String)request.getAttribute("wadat"));
      ...
      out.write("  \twindow.location.href=\"/delOrdPre.do\";\r\n");
      out.write("  }\r\n");
      ...
      out.write("  \t\tdocument.listForm.action=\"/delordList.do\";\r\n");
      ...
      out.write("\t\t\t\t\t\t<input  type=\"button\" style=\"width:40px;\"  value=\"返回\" onclick=\"window.location.href='/delOrdPre.do';\"></input>\r\n");
      out.write("\t\t\t\t\t\t<input  type=\"button\" style=\"width:40px;\"  onclick=\"window.location.href='/main.do';\" value=\"首页\"></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t");
	return;} 
	...
	return;} 
      ...
      out.write("\t\t\t\t\t<td class=\"td_list\" >交货单号</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t");
 ...
 if(i%2==1){ 
      ...
      out.write("\t\t\t\t\t<td class=\"td_list\" >\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t <a href=\"/delordView.do?vbeln=");
      out.print(pic.getVbeln() );
      out.write("&werks=");
      out.print(werks );
      out.write("&lgort=");
      out.print(lgort );
      ...
      out.write("\t\t\t<tr >\r\n");
      out.write("\t\t\t\t<td align=\"center\" colspan=\"2\">\r\n");
      out.write("\t\t\t\t\t<input  type=\"button\" style=\"width:40px;\" value=\"上一页\" onclick=\"lastPage();\"/>\r\n");
      out.write("\t\t\t\t\t<input  type=\"button\" style=\"width:30px;\"  value=\"返回\" onclick=\"window.location.href='/delOrdPre.do';\"></input>\r\n");
      out.write("\t\t\t\t\t<input  type=\"button\" style=\"width:30px;\"  onclick=\"window.location.href='/main.do';\" value=\"首页\">\r\n");
      out.write("\t\t\t\t\t<input  type=\"button\" style=\"width:40px;\"  value=\"下一页\" onclick=\"nextPage();\"/>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\t</table>\r\n");

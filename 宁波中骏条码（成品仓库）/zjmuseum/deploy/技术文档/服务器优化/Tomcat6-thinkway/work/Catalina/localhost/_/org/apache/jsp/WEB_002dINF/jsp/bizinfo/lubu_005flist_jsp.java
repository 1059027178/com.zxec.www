...
public final class lubu_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String uploadDir = "/ckeditor/uploader/upload/";
	...
	String bwlvs=LiangxinUtil.null2String((String)request.getAttribute("bwlvs"));
      ...
      out.write("\tdocument.listForm.action=\"/lubuList.do\";\r\n");
      ...
      out.write("\t<form action=\"/lubuEdit.do\" id=\"listForm\" name=\"listform\" method=\"get\">\r\n");
      out.write("\t<input type=\"hidden\" id=\"bwlvs\" name=\"bwlvs\" value=\"");
      out.print(bwlvs );
      out.write("\"/>\r\n");
      ...
      out.write("\t\t\t\t\t\t<input type=\"button\" class=\"button\" style=\"width:40px;height:25px;\"  type=\"button\" value=\"返回\" onclick=\"forward()\"/>\r\n");
      out.write("\t\t\t\t\t\t<input type=\"button\" class=\"button\" style=\"width:40px;height:25px;\" onclick=\"window.location.href='/main.do';\" value=\"首页\">\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t");
	...
	return;} 
      ...
      out.write("\t\t\t\t\t<td class=\"td_list\">日期</td>\r\n");
 ...
 if(i%2==1){ 
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">");
      out.print(LiangxinUtil.null2String(pic.getTdatu()) );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">");
 ...
 if(i%2==1){ 
      ...
      out.print(lgnum );
      out.write(',');
      out.print(LiangxinUtil.null2String(pic.getUbnum()) );
      out.write(',');
 ...
 if(i%2==1){ 
      ...
      out.write("\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td align=\"center\"  colspan=3><input  type=\"button\" class=\"button\" style=\"width:45px;\" value=\"上一页\" onclick=\"lastPage();\"/>\r\n");
      out.write("\t\t\t\t\t<input  class=\"button\" style=\"width:35px;\"  type=\"button\" value=\"返回\" onclick=\"forward()\"/>\r\n");
      out.write("\t\t\t\t<input class=\"button\" style=\"width:35px;\" value=\"确定\"  type=\"submit\"/>\r\n");
      out.write("\t\t\t\t<input type=\"button\" class=\"button\" style=\"width:35px;height:25px;\" onclick=\"window.location.href='/main.do';\" value=\"首页\">\r\n");
      out.write("\t\t\t\t<input  type=\"button\" class=\"button\" style=\"width:45px;\"  value=\"下一页\" onclick=\"nextPage();\"/></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t\t</form>\r\n");

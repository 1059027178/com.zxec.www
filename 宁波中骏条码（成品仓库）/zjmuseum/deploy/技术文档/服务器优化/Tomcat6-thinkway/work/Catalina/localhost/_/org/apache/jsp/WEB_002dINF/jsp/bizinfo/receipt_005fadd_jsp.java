...
public final class receipt_005fadd_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("  \r\n");
      out.write("  <body>\r\n");
      out.write("  <form name=form action=\"/receiptView.do\">\r\n");
      out.write("  <input type=\"hidden\" name=\"sonum\" id=\"sonum\" >\r\n");
      out.write("  \t<div>\r\n");
      out.write("  \t\t<ul>\r\n");
      out.write("  \t\t\t<li style=\"height:15px;list-style-type:none;padding:0; margin:0;}\"><input name=\"str\" style=\"height:20px;\" type=\"text\" style=\"white-space：nowrap;width:70%;\"  id=\"str\" onchange=\"js()\"></li>\r\n");
      out.write("  \t\t\t<li class=\"li\">生产订单：<input name=\"aufnr\" style=\"height:20px;\" size=\"5\" readonly=readonly class=\"text\"  type=\"text\"  id=\"aufnr\" > </input></li>\r\n");
      out.write("  \t\t\t<li class=\"li\">物料编码：<input name=\"matnr\" style=\"height:20px;\" class=\"text\"  readonly=readonly type=\"text\" id=\"matnr\"></li>\r\n");
      out.write("  \t\t\t<li class=\"li\">物料描述：<input name=\"maktx\" style=\"height:20px;\" class=\"text\"  readonly=readonly type=\"text\" id=\"maktx\"></li></br>\r\n");
      out.write("  \t\t\t<li class=\"li\">尾箱标识：<input type=\"checkbox\" onclick=\"choose1();\" id=\"bs\" style=\"width:20px;height:20px;\" name=\"bs\"></li>\r\n");
      out.write("  \t\t\t<li class=\"li\">箱数量/箱数：<input name=\"meng\" style=\"height:20px;\" readonly=readonly style=\"width:30px;background-color:#D8D8D8;height:20px;\"  type=\"text\"  id=\"meng\">/<input name=\"boxs\" style=\"width:30px;height:20px;\" type=\"text\"  id=\"boxs\" onblur=\"acount();\"></li>\r\n");
      ...
      out.write("  \t\t\t<li class=\"li\">特殊库存：<input name=\"sobkz\" style=\"height:20px;\" readonly=readonly type=\"text\" class=\"text\"  id=\"sobkz\"></li>\r\n");
      out.write("  \t\t\t<li class=\"li\"><input type=\"button\" style=\"width:50px;height:25px;\" valign=\"center\" class=\"button\" onclick=\"submit1(this);\" value=\"确定\"/>\r\n");
      ...
      out.write("  \t\t\t<input   type=\"button\" class=\"button\" style=\"width:50px;height:25px;\" onclick=\"window.location.href='/main.do';\" value=\"首页\"></li>\t\r\n");
      out.write("  \t\t</ul>\r\n");
      out.write("  \t</div>\r\n");
      out.write("     \r\n");
      out.write("</form>\r\n");

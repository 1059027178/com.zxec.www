...
public final class stoquy_005fList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String uploadDir = "/ckeditor/uploader/upload/";
	...
	String pici=LiangxinUtil.null2String((String)request.getAttribute("pici")); 
      ...
      out.write("\t<form  id=\"listForm\" name=\"listform\" method=\"post\" action=\"/stoquyList.do\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<input type=\"button\" value=\"返回\" style=\"width:50px;heigth=20%\" onclick=\"window.location.href='/stoquyQuery.do';\"></input>\r\n");
...
if(list.size()==0){
 ...
 if(i%2==1){ 
      ...
      out.print(sto.getMatnr() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\"  colspan=\"2\">");
      out.print(sto.getMaktx() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">");
 ...
 if(i%2==1){ 
      ...
      out.write("\r\n");
      out.write("\t\t\t<tr >\r\n");
      out.write("\t\t\t\t<td align=\"center\" colspan=\"4\"><input class=button type=\"button\" style=\"width:50px;\" value=\"上一页\" onclick=\"lastPage();\"/>\r\n");

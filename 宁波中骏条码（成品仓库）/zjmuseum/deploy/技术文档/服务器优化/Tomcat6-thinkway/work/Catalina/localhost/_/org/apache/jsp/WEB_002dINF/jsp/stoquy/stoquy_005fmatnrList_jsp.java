...
public final class stoquy_005fmatnrList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/WEB-INF/jsp/stoquy/../include/const.jsp");
...
String uploadDir = "/ckeditor/uploader/upload/";
	...
	String pici=LiangxinUtil.null2String((String)request.getAttribute("pici")); 
      ...
      out.write("  \t\tdocument.listForm.action=\"/stoquyList.do\";\r\n");
      ...
      out.write("\t<form  id=\"listForm\" name=\"listform\" method=\"post\" action=\"/delordpicAdd.do\">\r\n");
      ...
      out.print(pageNo );
      out.write("\"/>\r\n");
      out.write("\t\t<input type=\"hidden\" id=\"pici\" name=\"pici\" value=\"");
      out.print(pici );
      out.write("\"/>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t<input type=\"text\" style=\"background-color:#D8D8D8;\" name=\"matnr\" style=\"width:70%\"  id=\"matnr\" readonly=\"true\" value=\"");
      ...
      out.write("\t\t\t\t\t<td  class=\"td_list\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" style=\"background-color:#D8D8D8;\" name=\"maktx\" style=\"width:70%\"  id=\"maktx\" readonly=\"true\" value=\"");
      ...
      out.write("\t\t\t\t\t\t\t<input type=\"button\" value=\"返回\" onclick=\"window.location.href='/stoquyQuery.do';\"></input>\r\n");
...
if(list.size()==0){
	...
	return;} 
      ...
      out.write("\t\t\t\t\t<td class=\"td_list\" colspan=\"2\">批次</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
 ...
 if(i%2==1){ 
      ...
      out.write(">\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">");
      out.print(sto.getSobkz() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">");
      out.print(sto.getSonum() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">");
      out.print(sto.getLabst() );
      out.print(sto.getVerme() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr ");
 if(i%2==1){ 
      ...
      out.write(">\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\">");
      out.print(sto.getMeins() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"td_list\" colspan=\"2\">");
      out.print(sto.getCharg() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t<tr >\r\n");
      out.write("\t\t\t\t<td align=\"center\" colspan=\"3\"><input class=\"button\" type=\"button\" style=\"width:50px;\" value=\"上一页\" onclick=\"lastPage();\"/>\r\n");
      out.write("\t\t\t\t\t\t<input class=\"button\"  type=\"button\" style=\"width:40px;\" value=\"返回\" onclick=\"window.location.href='/stoquyQuery.do';\"></input>\r\n");
      out.write("\t\t\t\t\t\t<input  class=button type=\"button\" style=\"width:40px;\" onclick=\"window.location.href='/main.do';\" value=\"首页\">\r\n");
      out.write("\t\t\t\t\t\t<input class=\"button\"  type=\"button\" style=\"width:50px;\" value=\"下一页\" onclick=\"nextPage();\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("</div>\r\n");

...
public class AutoGen {
  ...
  `exhibitDesp` mediumtext  DEFAULT NULL COMMENT '展品介绍',
		...
		//展品
		iMap = new LinkedHashMap();
		iMap.put("objno", "String|工号|R|input");
		iMap.put("name", "String|姓名|R|input");
		iMap.put("department", "String|部门|R|input");
		iMap.put("sex", "String|性别|R|select");
		tu.process("cms", "hrminfo", "人员信息", iMap);

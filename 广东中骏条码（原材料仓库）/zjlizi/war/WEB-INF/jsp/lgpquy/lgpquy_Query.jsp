  ...
  <body>
    <form name="jiuhui"  id="jiuhui" action="/lgpquyList.do">
    	...
    	<li class="li" style="margin-bottom: 20px;">
    		...
    		<li class="li">
    			仓库号：<input style="width:60%;height:25px;" type="text" id="lgnum" name="lgnum"  value="321"/>
    		</li>
    		<li class="li" style="margin:20px 0px 0px -15px;">
    			<input  class="button"  type="button" valign="center" style="width:40px;height:25px;"  onclick="lgpQuy()" value="查询">
    			<input  class="button"  type="button" valign="center" style="width:40px;height:25px;"  onclick="reset();" value="清除">

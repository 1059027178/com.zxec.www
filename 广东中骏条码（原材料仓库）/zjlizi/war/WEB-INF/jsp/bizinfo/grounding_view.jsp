...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <form name="form" action="/groundingEdit.do">
     ...
     <ul>
		...
		<li class="li" style="margin:20px 0px 0px 0px;">存<span style="margin-left:7px;"></span>储<span style="margin-left:7px;"></span>区：<input name="lgber" class="text" style="background-color:#D8D8D8;" readonly= readonly type="text"  id="lgber" value="${lgber}"/> </li>

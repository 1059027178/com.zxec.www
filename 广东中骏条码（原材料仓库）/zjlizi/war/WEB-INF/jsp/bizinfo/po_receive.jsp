								...
								<ul>
									...
									<li class="li">每袋数量/袋数：<input class="text"
										...
										style="width:40px;" name="meng">/<input class="text3"
											type="text" style="width:38px;" id="pockets" name="boxs">
									</li>
		...
		<div id="page2" style="display:none">
			<div style="padding-top:50px;">
				<ul>
					...
					<li class="li"><input type="button" valign="center"
						style="width:40px;height:25px;" class="button" id="shelves"
						value="上架" /> <input type="button" id="back2"
...
<script type="text/javascript">
	$(function() {
		...
		$("#pockets").change(function() {
			...
			var meng = $("#pockets").val();
			var boxs = $("#perAmount").val();
			if (meng == "")
				meng = 0;
			...
			if (meng == '' || meng == null)
				return;
			$("#totalAmount").attr("value", parseFloat(meng) * parseFloat(boxs));

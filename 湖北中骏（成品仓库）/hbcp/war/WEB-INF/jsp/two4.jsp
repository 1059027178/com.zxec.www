...
<table style="width:100%" class="table_border">
  	<tr>
  	<td>
    	<input  class=button type="button" style="width:200px" onclick="window.location.href='/repertoryAdd.do';" value="1.仓位冻结/解冻">
      </td>
    </tr>
    <tr>
    <td>
    	<input  class=button type="button" style="width:200px" onclick="window.location.href='/storageMView.do';" value="2.仓位转移">
      </td>
    </tr>
    <tr>
    <td>

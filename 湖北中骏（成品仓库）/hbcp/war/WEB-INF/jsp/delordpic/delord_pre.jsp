...
<html>
 ...
 function submit1(obj){
  ...
  <div class="div" style="padding-top:50px;">
	...
	<ul>
     	<li class="li">工&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;厂：<input name="werks" class="text" style="background-color:white;" type="text"  id="werks" value="3300"> </input>
		</li>
		<li class="li" >库存地点：<input name="lgort" style="background-color:white;" class="text" type="text"  id="lgort" value="3311">
		</li>

...
public class GetCostDController implements Controller, AuthenticateController {
...
//						sapRequest = new SAPRequest(("ZFM_BC_15_22"));
						sapRequest = new SAPRequest(("ZFM_BC_18_22"));
						sapRequest
						...
						sapRequest.addParameter("I_ZEILE", SapUtil.null2String(request.getParameter("lineItem")));
						sapRequest.addParameter("I_MBLNR",
								SapUtil.null2String(request.getParameter("costGettenId")));
						sapRequest.addParameter("I_TANUM", depositListId);
						sapRequest.addParameter("I_ZJPSL", obj.getString("selectAmount"));
		...
		models.put("costGettenId", SapUtil.null2String(request.getParameter("costGettenId")));

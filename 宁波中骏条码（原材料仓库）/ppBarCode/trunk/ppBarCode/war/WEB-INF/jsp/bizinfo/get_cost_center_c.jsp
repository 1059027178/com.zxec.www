...
<%
	...
	String costGettenId = (String) request
			.getAttribute("costGettenId");
...
<BODY>
	<div class="div">
		<form id="form" name="form" action="/getCostD.do" method="post"
			...
			<table class="table_list"
				...
				<input type="hidden" name="costGettenId"
					value="<%=costGettenId%>" />
				...
				<tr>
					<td>需求数量：<label id="requireAmount"><%=requireTotal%></label>
					</td>
				</tr>

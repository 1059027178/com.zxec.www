...
<BODY>
  		...
  		<ul>
			...
			<li class="li">用户<span style="margin-left: 14px;"></span>别名：<input name="userName" class="text"  type="text"  id="userName"  style="width:90px;background-color:white;" value="${userObj.userName}"></li>
  			...
  			<li class="li">
  			<input type="button" valign="center" style="width:40px;height:25px;margin:20px 0px 0px -30px;" class="button" onclick="save();" value="确定"/>

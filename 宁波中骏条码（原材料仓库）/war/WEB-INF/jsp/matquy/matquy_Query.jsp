...
function matQuy(){
  ...
  <body>
    <form name="jiuhui"  id="jiuhui" action="/matquyList.do">
    	...
    	<ul>
    		<li class="li">
    			<input style="width:75%;heigth:20%" type="text" id="saomiao" onchange="js()" name="saomiao"  value=""/>
    		</li>
    		<li class="li">
		    ...
		    <li class="li" style="margin:10px 0px 0px -15px；">
    			<input  class="button"  type="button"  valign="center" style="width:40px;height:25px;" onclick="matQuy()" value="查询">
    			<input  class="button"  type="button"  valign="center" style="width:40px;height:25px;"  onclick="reset();" value="重置">
    			<input  class="button"  type="button"  valign="center" style="width:40px;height:25px;" onclick="window.location.href='/main.do?two=5';" value="返回"></td>
